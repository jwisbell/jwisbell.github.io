---
title: Jacob Isbell, Astronomer
tags: agn, galaxy evolution, interferometry
---

<!-- Make this a component??? -->

![alt text](https://www.as.arizona.edu/sites/default/files/people/Jacob%20Isbell_WS.png "Me")
![alt text](./ThesisCover.png "PhD Thesis Cover")
...
by Isbell, Jacob W. ; Ertel, Steve ; Wagner, Kevin ; Rousseau, Hélène ; Power, Jennifer ; Carlson, Jared ; Becker, Alex ; Rupert, Justin ; Hinz, Philip ; Hoffman, William F. ; Leisenring, Jarron ; Stone, Jordan ; Spalding, Eckhart

[Proceedings of the SPIE, Volume 13095, id. 1309506 17 pp. (2024)](https://www.spiedigitallibrary.org/conference-proceedings-of-spie/13095/3027270/The-LBTI-pioneering-the-ELT-era/10.1117/12.3027270.short)
...
[_Astronomy & Astrophysics, Volume 678, id.A136, 23 pp._](https://ui.adsabs.harvard.edu/abs/2023A%26A...678A.136I/abstract)
...
I recently published an LBTI Fizeau imaging reduction pipeline. It makes this relatively new observing mode more accessible by documenting and handling the (now well-tested) reduction and calibration steps. It can be found here: [LIZARD Pipeline](https://github.com/jwisbell/lbti_fizeau)
...
During the pandemic, I worked with three other PhD students to develop a platform for interactive, virtual poster sessions. This project was used at numerous virtual conferences, group meetings, and poster competitions. While the project has since evolved in a different direction, I am incredibly proud of what we built together and of the connections made within the platform.
